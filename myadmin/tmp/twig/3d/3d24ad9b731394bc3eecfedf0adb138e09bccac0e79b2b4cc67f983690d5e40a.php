...
class __TwigTemplate_8a305b7fa4c931cb457a682521b697477bbed620f66345e8146e1ee7f73597ba extends \Twig\Template
{
    ...
    {
        // line 1
        (( !twig_test_empty((isset($context["dropdown_question"]) ? $context["dropdown_question"] : null))) ? (print (twig_escape_filter($this->env, (isset($context["dropdown_question"]) ? $context["dropdown_question"] : null), "html", null, true))) : (print ("")));
        // line 2
        echo "<select name=\"";
...
";
    ...
    {
        return new Source("", "table/relation/dropdown_generate.twig", "/var/www/html/myadmin/templates/table/relation/dropdown_generate.twig");
    }
}
