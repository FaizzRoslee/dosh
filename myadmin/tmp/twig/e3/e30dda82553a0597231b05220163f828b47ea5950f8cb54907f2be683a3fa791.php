...
class __TwigTemplate_6dbddd1b63d45596e547f7adc09c172ea44c6a794a52488c2b6ec4f36d4cdffb extends \Twig\Template
{
...
<table id=\"partition_table\">
    <tr class=\"vmiddle\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["option"]) {
            ...
            echo "\"";
            // line 22
            if (($this->getAttribute((isset($context["partition_details"]) ? $context["partition_details"] : null), "partition_by", [], "array") == $context["option"])) {
                // line 23
        ...
        echo "\"
                value=\"";
        // line 33
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["partition_details"]) ? $context["partition_details"] : null), "partition_expr", [], "array"), "html", null, true);
        echo "\" />)
        </td>
    </tr>
    <tr class=\"vmiddle\">
        ...
        <td colspan=\"2\">
            <input name=\"partition_count\" type=\"number\" min=\"2\"
                value=\"";
        // line 40
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["partition_details"]) ? $context["partition_details"] : null), "partition_count", [], "array"), "html", null, true);
        echo "\" />
        </td>
    </tr>
    ";
        // line 43
        if ($this->getAttribute((isset($context["partition_details"]) ? $context["partition_details"] : null), "can_have_subpartitions", [], "array")) {
            // line 44
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["option"]) {
                ...
                echo "\"";
                // line 50
                if (($this->getAttribute((isset($context["partition_details"]) ? $context["partition_details"] : null), "subpartition_by", [], "array") == $context["option"])) {
                    // line 51
                    echo "                            selected=\"selected\"";
                }
                // line 52
            ...
            echo "\"
                    value=\"";
            // line 61
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["partition_details"]) ? $context["partition_details"] : null), "subpartition_expr", [], "array"), "html", null, true);
            echo "\" />)
            </td>
        </tr>
        <tr class=\"vmiddle\">
            ...
            <td colspan=\"2\">
                <input name=\"subpartition_count\" type=\"number\" min=\"2\"
                       value=\"";
            // line 68
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["partition_details"]) ? $context["partition_details"] : null), "subpartition_count", [], "array"), "html", null, true);
            echo "\" />
            </td>
        </tr>
    ";
...
";
        // line 73
        if (($this->getAttribute((isset($context["partition_details"]) ? $context["partition_details"] : null), "partition_count", [], "array") > 1)) {
            // line 74
        ...
        <thead><tr>
            ...
            ";
            // line 77
            if ($this->getAttribute((isset($context["partition_details"]) ? $context["partition_details"] : null), "value_enabled", [], "array")) {
                // line 78
                echo "                <th>";
            ...
            // line 80
            echo "            ";
            if (($this->getAttribute((isset($context["partition_details"]) ? $context["partition_details"] : null), "can_have_subpartitions", [], "array") && ($this->getAttribute(            // line 81
(isset($context["partition_details"]) ? $context["partition_details"] : null), "subpartition_count", [], "array") > 1))) {
                // line 82
                echo "                <th>";
        ...
        ";
            // line 93
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable($this->getAttribute((isset($context["partition_details"]) ? $context["partition_details"] : null), "partitions", [], "array"));
...
$context["partition"], "subpartition_count", [], "array") + 1)) : (2));
            ...
            ";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["subpartition"]) {
                    ...
                    ";
                    // line 129
                    if (($this->getAttribute((isset($context["partition_details"]) ? $context["partition_details"] : null), "can_have_subpartitions", [], "array") && ($this->getAttribute(                    // line 130
(isset($context["partition_details"]) ? $context["partition_details"] : null), "subpartition_count", [], "array") > 1))) {
                        // line 131
                        echo "                        <td>
                            <input type=\"text\" name=\"";
...
";
    ...
    {
        return new Source("", "columns_definitions/partitions.twig", "/var/www/html/myadmin/templates/columns_definitions/partitions.twig");
    }
}
