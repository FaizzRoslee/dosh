...
class __TwigTemplate_e12505fe93fa6993ee7fee5a42757a343765d4eb6bcca4d314051c8ec9f82af4 extends \Twig\Template
{
    ...
    ";
        ...
        // line 6
        echo "        ";
        if ($this->getAttribute((isset($context["one_key"]) ? $context["one_key"] : null), "constraint", [], "array", true, true)) {
            // line 7
            echo "            ";
...
(isset($context["one_key"]) ? $context["one_key"] : null), "constraint", [], "array"))) . ";");
            // line 11
            echo "            ";
...
(isset($context["one_key"]) ? $context["one_key"] : null), "constraint", [], "array")) . ";"));
        ...
        if ($this->getAttribute((isset($context["one_key"]) ? $context["one_key"] : null), "constraint", [], "array", true, true)) {
            ...
            // line 31
            echo "            ";
            echo PhpMyAdmin\Util::linkOrButton((isset($context["drop_url"]) ? $context["drop_url"] : null), (isset($context["drop_str"]) ? $context["drop_str"] : null), ["class" => "drop_foreign_key_anchor ajax"]);
            echo "
        ";
        }
        // line 33
    ...
    <td>
        ...
        echo "]\" value=\"";
        // line 37
        (($this->getAttribute((isset($context["one_key"]) ? $context["one_key"] : null), "constraint", [], "array", true, true)) ? (print (twig_escape_filter($this->env, $this->getAttribute((isset($context["one_key"]) ? $context["one_key"] : null), "constraint", [], "array"), "html", null, true))) : (print ("")));
        // line 38
        echo "\" placeholder=\"";
        ...
        // line 44
        echo "            ";
        $context["on_delete"] = (($this->getAttribute((isset($context["one_key"]) ? $context["one_key"] : null), "on_delete", [], "array", true, true)) ? ($this->getAttribute(        // line 45
(isset($context["one_key"]) ? $context["one_key"] : null), "on_delete", [], "array")) : ("RESTRICT"));
        // line 46
        echo "            ";
        $context["on_update"] = (($this->getAttribute((isset($context["one_key"]) ? $context["one_key"] : null), "on_update", [], "array", true, true)) ? ($this->getAttribute(        // line 47
(isset($context["one_key"]) ? $context["one_key"] : null), "on_update", [], "array")) : ("RESTRICT"));
        // line 48
...
(isset($context["on_update"]) ? $context["on_update"] : null)]));
    ...
    <td>
        ";
        // line 67
        if ($this->getAttribute((isset($context["one_key"]) ? $context["one_key"] : null), "index_list", [], "array", true, true)) {
            // line 68
            echo "            ";
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable($this->getAttribute((isset($context["one_key"]) ? $context["one_key"] : null), "index_list", [], "array"));
...
(isset($context["column_array"]) ? $context["column_array"] : null), "selected_value" => ""]));
    ...
    ";
        ...
        if ((isset($context["foreign_db"]) ? $context["foreign_db"] : null)) {
            // line 95
            echo "        ";
            $context["tables"] = call_user_func_array($this->env->getFunction('Relation_getTables')->getCallable(), [(isset($context["foreign_db"]) ? $context["foreign_db"] : null), (isset($context["tbl_storage_engine"]) ? $context["tbl_storage_engine"] : null)]);
            // line 96
            echo "    ";
        }
        // line 97
...
(isset($context["foreign_table"]) ? $context["foreign_table"] : null)]));
    ...
    <td>
        ...
        if (((isset($context["foreign_db"]) ? $context["foreign_db"] : null) && (isset($context["foreign_table"]) ? $context["foreign_table"] : null))) {
            ...
            echo "            ";
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable($this->getAttribute((isset($context["one_key"]) ? $context["one_key"] : null), "ref_index_list", [], "array"));
...
(isset($context["i"]) ? $context["i"] : null)) . "][]"), "title" => _gettext("Column"), "values" => [], "foreign" => ""]));
            // line 137
            echo "            </span>
        ";
        }
...
";
    ...
    {
        return new Source("", "table/relation/foreign_key_row.twig", "/var/www/html/myadmin/templates/table/relation/foreign_key_row.twig");
    }
}
