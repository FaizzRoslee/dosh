...
class __TwigTemplate_8b8423ec468fd6940197df1948f333d08ed6fd0b6cd42bc81f04a9364226eedd extends \Twig\Template
{
...
$context["row"], "result_count", [])));
            ...
            // line 18
            echo "                ";
            echo sprintf((isset($context["result_message"]) ? $context["result_message"] : null), $this->getAttribute($context["row"], "result_count", []), $this->getAttribute($context["row"], "table", []));
            echo "
            </td>
            ";
            // line 20
...
";
    ...
    {
        return new Source("", "database/search/results.twig", "/var/www/html/myadmin/templates/database/search/results.twig");
    }
}
