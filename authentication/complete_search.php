<?php 
	...
	//==========================================================
	func_header_new(_LBL_SEARCH_REG_CHEM,
...
/* 		$('#example tbody tr[title]').tooltip( {
		...
		$(".cl_view").on('click', function(){
			...
			//$("#chemicalID").val(id);
                        //alert(id);
			//$("#myForm").submit();
                        $.post('/authentication/chemicalView_Search.php',{chemicalID:id},function(data){
    ...
    <form name="myForm" id="myForm" action="/authentication/chemicalView_Search.php" method="post">
