<?php 
    ...
    Update 20211101 : LinuxHouse is currently reponsible for the maintenance of this CIMS
                      ...
                      With regards to this registration file, link is
                      broken due to broken params from sys_config
	...
	********************************************************************************************/
	...
	if(isset($_POST["add"])){
     ...
     // linuxhouse_20211108
     // fix broken authentication/activate link

					$link = "https://".$_SERVER["SERVER_NAME"]. $sys_config["doc_root"]."authentication/activate.php?loginid=".$userid."&token=".$randomCode;
...
?>
    ...
    <form name="myForm" id="myForm" action="/authentication/registration.php" method="post">
	<div id="div_rel">
