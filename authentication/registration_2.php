	...
	if(isset($_POST['add'])){
		...
		if($valid == true) {
			...
			$checkLoginID	= _get_RowExist(
									'sys_User',
									array('AND Usr_LoginID'=>"= ".quote_smart($userid)),
									''
							);//$table='', $where=array(), $others=array()
			//==========================================================
			$checkCompNo	= _get_RowExist(
									'sys_User u',
									array('AND uc.Company_No'=>"= ".quote_smart($companyNo)),
			...
			if($checkLoginID>0 || $checkCompNo>0){
				...
				if($resIns){
					...
					// $subj 	= 'Pendaftaran Sistem eInventory JKKP';
					// $msg 	= 'Pendaftaran telah berjaya sila klik link yang diberikan.<br />'
							// . 'http://'.$_SERVER['HTTP_HOST'].'/jkkp/eInventory/authentication/activate.php?loginid='.$userid.'&token='.$randomCode;
					// if($email!='') func_email($sys_config['email_admin'],$email,$subj,$msg);
					$link = 'http://'.$_SERVER['HTTP_HOST'].'/authentication/activate.php?loginid='.$userid.'&token='.$randomCode;
					...
					echo '
						<script language="Javascript">
						alert("Your Registration not completed yet until you click a link that sent to your mailbox!");
...
?>
	...
	<div id="div_rel">
	<!--<fieldset><legend style="<?= $legendStyle ?>"><strong><?= _LBL_COMPANY_INFO ?></strong></legend>-->
	<table border="0" class="contents" cellspacing="1" cellpadding="3" width="100%" align="center">
		...
		<tr class="contents">
			<td class="label"><?= _LBL_REGISTRATION_NO . $requiredField ?></td>
			<td colspan="3"><?php
				$param1 = 'regNo';
		...
		<tr class="contents">
			...
			<td colspan="3"><?php
				// $param1 = 'contactCode';
				// $param2 = '';
				// $param3 = _get_arraySelect('sys_PhoneCode','PhoneCode_ID','PhoneCode');//($tblName='',$colID='',$colDesc='',$colWhere=array())
				// $param4 = isset($_POST[$param1])?$_POST[$param1]:$contactCode;
	...
	<fieldset>
	<legend style="<?= $legendStyle ?>"><strong><?= _LBL_CONTACT_PERSON ?></strong></legend>
	<table border="0" class="contents" cellspacing="1" cellpadding="3" width="100%" align="center">-->
		<tr class="contents" height="28">
	...
	<fieldset>
	<legend style="<?= $legendStyle ?>"><strong><?= _LBL_USER_ID_PASSWORD ?></strong></legend>
	<table border="0" class="contents" cellspacing="1" cellpadding="3" width="100%" align="center">-->
		<tr class="contents" height="28">
	...
	<fieldset>
	<legend style="<?= $legendStyle ?>"><strong><?= _LBL_ANSWER_IF_FORGOT_ID_PASSWORD ?></strong></legend>
	<table border="0" class="contents" cellspacing="1" cellpadding="3" width="100%" align="center">-->
		<tr class="contents" height="28">
	...
	<fieldset>
	<legend style="<?= $legendStyle ?>"><strong><?= _LBL_VERIFICATION_CODE ?></strong></legend>
	<table border="0" class="contents" cellspacing="1" cellpadding="3" width="100%" align="center">-->
		<tr class="contents" height="28">
