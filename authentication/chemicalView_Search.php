<?php
	...
	func_header_new("",
				...
				$sys_config['includes_path']."javascript/check-click-download-2.js,". // javascript
...
?>
	...
	<?= form_input('searchWord',$searchWord,array('type'=>'hidden')); ?>
            <table class="table table-bordered" border="0" class="contents" cellspacing="1" cellpadding="3" width="100%">
	...
	<br />
	<table border="0" class="table table-bordered contents" cellspacing="1" cellpadding="3" width="100%">
		<tr class="contents" height="28">
	...
	<table border="0" class="table table-bordered contents" cellspacing="1" cellpadding="3" width="100%">
        ...
        <tr class="contents">
			...
			<td colspan="3">
                <span class="formInfo">
                    <?= !empty($propPdf) ? '<a href="'. $sys_config["authentication_path"] .'download2.php?file='. nl2br($propPdf) .'" id="a-formula2" onclick="return checkClickDownload2()" class="btn btn-info btn-sm active">'. _LBL_DOWNLOAD_FILE .'</a>' : '-' ?>
                </span>
            </td>
		</tr>
