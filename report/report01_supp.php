	...
	<table width="100%">
		<tr>
			<td align="center"><?php
				...
				if($bil>0){
					$url_excel = 'report01_to_excel_supp.php?rptType='.$rptType.'&chemType='.$chemType.'&rptYear='.$rptYear."&aaa";
...
// 				if($bil>0){
// 					$url_word = 'report01_to_word_supp.php?rptType='.$rptType.'&chemType='.$chemType.'&rptYear='.$rptYear."&aaa";
