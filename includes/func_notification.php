<?php
	...
	function _get_Notification($cat=0,$usr_id=0,$sid=0,$link=''){
		...
		if($cat!=0 && $usr_id!=0){
			...
			$bodyLower .= '	<br />';
			$bodyLower .= '	Administrator';
			$bodyLower .= '	<br />';
			$bodyLower .= '	Tel : '. $sys_config["org_phone_no"];
			$bodyLower .= '	<br />';
			$bodyLower .= '	Fax : '. $sys_config["org_fax_no"];
			$bodyLower .= '	<br />';
			$bodyLower .= '	<br />';
			
			
            // linuxhouse_20220607
            // start email notification for rejection 1
            // debug last sentence in body of email
			
			$bodyLower .= '	Please note: This is an auto generated e-mail that cannot receive replies.';
			
            // end email notification for rejection 1
			...
			if($cat==1){ //registration acknowledge
				//==================================
				$title = 'CIMS, Account Registration Successful';
				//==================================
				//$str = '<pre>';
				$str = '	Dear Sir,';
				$str .= '	<br />';
			...
			elseif($cat==2){ //acknowledge new
				...
				//==================================
				$title = 'CIMS, Chemical Submission Acknowledgement';
				//==================================
				//$str = '<pre>';
				$str = '	Dear Sir,';
				$str .= '	<br />';
			...
			elseif($cat==3){ //acknowledge renew
				...
				//==================================
				$title = 'CIMS, Chemical Submission Renewal Acknowledgement';
				//==================================
				//$str = '<pre>';
				$str = '	Dear Sir,';
				$str .= '	<br />';
			...
			elseif($cat==4){ //acknowledge renew
				//==================================
				$title = 'CIMS, Account Activation';
				//==================================
				//$str = '<pre>';
				$str = '	Dear Sir,';
				$str .= '	<br />';
				$str .= '	<br />';
				$str .= '	Thank you for registering with CIMS.';
				$str .= '	<br />';
				$str .= '	<br />';
				...
				$str .= '	<br />';
				$str .= '	<br />';
				$str .= '	Please click the link below to activate and login to your account. This link will expire in 3 days.';
				$str .= '	<br />';
				$str .= '	<br />';
			...
			elseif($cat==5){ //new submission sent for approval
				// $where = array('AND Submission_ID'=>'= '.quote_smart($sid),'AND Sub_Record_Status'=>'= 11','ORDER BY'=>'Sub_Record_ID DESC');
				//==================================
				$title = 'CIMS, Submission';
				//==================================
				//$str = '<pre>';
				$str = '	Dear Sir,';
				$str .= '	<br />';
				$str .= '	<br />';
				$str .= '	Your inventory was sent to DOSH for acknowledgement.';
				$str .= '	<br />';
				$str .= '	<br />';
				$str .= $compInfo;
				$str .= '	<strong>Submission Info</strong>';
...
// 				$where = array('AND Submission_ID'=>'= '.quote_smart($sid),'AND Sub_Record_Status'=>'= 11','ORDER BY'=>'Sub_Record_ID DESC');
// 				==================================
// 				$title = 'CIMS, Submission Not Acknowledged';
// 				==================================
// 				$str = '<pre>';
// 				$str = '	Dear Sir,';
// 				$str .= '	<br />';
...
// 			}
			elseif($cat==7){ //new submission rejected
                ...
                // linuxhouse_20220607
                // start email notification for rejection 2
                // add rejection info in body of email
                
                $str .= '	<strong>Rejection Info</strong>';
				$str .= '	<br />';
				$str .= '	Reason/Notes: '. _get_StrFromCondition('tbl_Submission','CheckedReason','Submission_ID',$sid);
				$str .= '	<br />';
				$str .= '	Remarks: '. _get_StrFromCondition('tbl_Submission','CheckedRemark','Submission_ID',$sid);
				$str .= '	<br />';
				$str .= '	Contact No: '. _get_StrFromCondition('tbl_Submission','CheckedContact','Submission_ID',$sid);
				
				// end email notification for rejection 2
			...
			elseif($cat==8){ //renew submission rejected
				// $where = array('AND Submission_ID'=>'= '.quote_smart($sid),'AND Sub_Record_Status'=>'= 12','ORDER BY'=>'Sub_Record_ID DESC');
				//==================================
				$title = 'CIMS, Submission Renewal Not Acknowledged';
				//==================================
				//$str = '<pre>';
				$str = '	Dear Sir,';
				$str .= '	<br />';
			...
			elseif($cat==9){ //reminder
				// $where = array('AND Submission_ID'=>'= '.quote_smart($sid),'AND Sub_Record_Status'=>'= 12','ORDER BY'=>'Sub_Record_ID DESC');
				//==================================
				$title = 'CIMS, Reminder to Submission Renewal';
				//==================================
				//$str = '<pre>';
				$str = '	Dear Sir,';
				$str .= '	<br />';
			...
			elseif($cat==15){ //new submission rejected
				// $where = array('AND Submission_ID'=>'= '.quote_smart($sid),'AND Sub_Record_Status'=>'= 11','ORDER BY'=>'Sub_Record_ID DESC');
				//==================================
				$title = 'CIMS, Submission Not Acknowledged';
				//==================================
                ...
                $str .= '	<strong>Rejection Info</strong>';
				$str .= '	<br />';
				$str .= '	Reason/Notes: '. _get_StrFromCondition('tbl_Submission','ApprovedReason','Submission_ID',$sid);
				$str .= '	<br />';
				$str .= '	Remarks: '. _get_StrFromCondition('tbl_Submission','ApprovedRemark','Submission_ID',$sid);
				$str .= '	<br />';
				$str .= '	Contact No: '. _get_StrFromCondition('tbl_Submission','ApprovedContact','Submission_ID',$sid);
	...
	function _get_Notification2($loginID='',$email='',$newPswd=''){
		...
		if($loginID!='' && $email!=''){
			...
			$arr_emel['email'] = $email;
			$arr_emel['title'] = 'CIMS, Forgot Password';
			//==================================
			$str = '	Dear Sir,';
			$str .= '	<br />';
			$str .= '	<br />';
			$str .= '	You have requested your Login Info. Please change your password after loging in using the given password';
			$str .= '	<br />';
			$str .= '	<br />';
			//$str .= $compInfo;
			$str .= '	<strong>Login Info</strong>';
	...
	function _get_Notification4($loginID="",$email=""){
		...
		if($loginID!="" && $email!=""){
			...
			$arr_emel['email'] = $email;
			$arr_emel['title'] = 'CIMS, Reset Password';
			//==================================
			$str = '	Dear Sir,';
			$str .= '	<br />';
			$str .= '	<br />';
