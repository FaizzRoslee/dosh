<?php
	...
	function _get_Notification($cat=0,$usr_id=0,$sid=0,$link=''){
		...
		//==================================
		if($cat!=0 && $usr_id!=0){
			$dataColumns 	= 'uc.Company_Name,uc.Company_No,u.Level_ID,u.ActivationDate,u.RecordDate,uc.Reg_ID,uc.Email';
			...
			elseif($cat==2){ //acknowledge new
				...
				$str .= '	<br />';
				$str .= '	<br />';
				$str .= '	Your chemical submission was acknowledge by JKKP.';
				$str .= '	<br />';
				$str .= '	<br />';
				$str .= $compInfo;
				...
				$str .= '	<br />';
				$str .= '	<br />';
				$str .= '	Acknowledge Date: '. func_ymd2dmy(_get_StrFromCondition('tbl_Submission','ApprovedDate','Submission_ID',$sid));
				$str .= '	<br />';
				$str .= '	<br />';
				$str .= $bodyLower;
				//$str .= '</pre>';
			...
			elseif($cat==3){ //acknowledge renew
				...
				$str .= '	<br />';
				$str .= '	<br />';
				$str .= '	Your chemical submission renewal was acknowledge by JKKP.';
				$str .= '	<br />';
				$str .= '	<br />';
				$str .= $compInfo;
			...
			elseif($cat==4){ //acknowledge renew
				...
				$str .= '	<br />';
				$str .= '	<br />';
				$str .= '	Please click link below to activate and login to your account';
				$str .= '	<br />';
				$str .= '	<br />';
				$str .= $link;
				$str .= '	<br />';
			...
			elseif($cat==5){ //new submission sent for approval
				...
				$str .= '	Submission ID: '. _get_StrFromCondition('tbl_Submission','Submission_Submit_ID','Submission_ID',$sid);
				$str .= '	<br />';
				$str .= '	Submission Date: '. getSubmitDate($sid);
				$str .= '	<br />';
				$str .= '	<br />';
				$str .= $bodyLower;
				//==================================
			...
			elseif($cat==7){ //new submission rejected
				// $where = array('AND Submission_ID'=>'= '.quote_smart($sid),'AND Sub_Record_Status'=>'= 11','ORDER BY'=>'Sub_Record_ID DESC');
				//==================================
				$title = 'JKKP System, Submission Not Acknowledge';
				//==================================
				//$str = '<pre>';
				$str = '	Dear Sir,';
				$str .= '	<br />';
				$str .= '	<br />';
				$str .= '	Your chemical Submission was not acknowledge by DOSH.';
				$str .= '	<br />';
				$str .= '	<br />';
				$str .= $compInfo;
				$str .= '	<strong>Submission Info</strong>';
			...
			elseif($cat==8){ //renew submission rejected
				// $where = array('AND Submission_ID'=>'= '.quote_smart($sid),'AND Sub_Record_Status'=>'= 12','ORDER BY'=>'Sub_Record_ID DESC');
				//==================================
				$title = 'JKKP System, Submission Renewal Not Acknowledge';
				//==================================
				//$str = '<pre>';
				$str = '	Dear Sir,';
				$str .= '	<br />';
				$str .= '	<br />';
				$str .= '	Your chemical Submission Renewal was not acknowledge by DOSH.';
				$str .= '	<br />';
				$str .= '	<br />';
				$str .= $compInfo;
				$str .= '	<strong>Submission Renewal Info</strong>';
	...
	//==========================================================================================
	function _get_Notification2($loginID='',$email='',$newPswd=''){ //retrieve password
		global $db;
		//==================================
		$arr_emel['email'] = '';
		$arr_emel['title'] = '';
