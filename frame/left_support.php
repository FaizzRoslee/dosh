				...
				<table width="1%" border="0" cellspacing="0" cellpadding="0">
					<tr><td>
						<ul id="menu"><?php
							...
							//===============================================
							$title	=	_LBL_CONTACT_US;
							$url	=	$sys_config['support_path']."contact.php";
							$menu	=	1;
							echo func_left_menu2($title,$url,$menu,$int_menu);
							//=======================================================
							$title	=	_LBL_FEEDBACK_FROM;
							$url	=	$sys_config['support_path']."feedback.php";
							$menu	=	2;
							echo func_left_menu2($title,$url,$menu,$int_menu);
							//=======================================================
							$title	=	_LBL_FREQUENTLY_ASK_Q;
							$url	=	$sys_config['support_path']."faq.php";
							$menu	=	3;
							echo func_left_menu2($title,$url,$menu,$int_menu);
							//=======================================================
						?>
