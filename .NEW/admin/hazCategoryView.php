<?php
	//****************************************************************/
	// filename: hazCategoryView.php
	// description: show detail of the category selected
	//****************************************************************/
	...
	/*********/
	if($categoryID!=0){
		$dataColumns = "Category_Name,Pictogram_ID,Signal_ID,Statement_ID,"
					.	"PreStatement_ID1,PreStatement_ID2,PreStatement_ID3,PreStatement_ID4,Class_ID,Type_ID,Active";
...
?>
	...
	<?php func_window_open2(_LBL_HAZARD_CATEGORY .' :: '. _LBL_VIEW); ?>
	...
	<table border="0" class="contents" cellspacing="1" cellpadding="3" width="100%">
		...
		<tr class="contents">
			...
			<td width="80%"><label><?= _get_StrFromCondition('tbl_Hazard_Classification','Class_Name','Class_ID',$classID); ?></label></td>
		</tr>
		<tr class="contents">
	...
	<table border="0" class="contents" cellspacing="1" cellpadding="3" width="100%">
		<tr class="contents">
			<td align="center"><?php
				/*********/
				$dOthers = array("type"=>"button","onClick"=>"redirectForm('hazCategoryAddEdit.php?categoryID=$categoryID');");
				echo form_button("edit",_LBL_EDIT,$dOthers);
				/*********/
				echo "&nbsp;";
				/*********/
				$dOthers = array("type"=>"button","onClick"=>"redirectForm('hazCategoryList.php');");
