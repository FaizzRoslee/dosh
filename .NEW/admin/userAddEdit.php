<?php
	...
	// description: add/edit details of the user
	//****************************************************************/
		...
		if($checkLoginID>0 || $checkCompNo>0){
			...
			if($Usr_ID!=0){
				...
				$sqlUpd	= "UPDATE sys_User_Client SET"
						. " Company_No = ". quote_smart($companyNo) .",Company_Name = ". quote_smart($companyName) .",Reg_No = ". quote_smart($regNo) .","
				...
				$token	= _get_StrFromCondition("sys_User_Client","Token","Usr_ID",$Usr_ID);
				if($token!="" && $active==1){
					/*********/
					...
					$sql	= "UPDATE sys_User u"
							...
							. " uc.Token = ''"
							. " WHERE u.Usr_ID = ". quote_smart($Usr_ID) ."";
							//echo $sql;
				...
				$sqlIns	= "INSERT INTO sys_User ("
						...
						. " Active"
						. " ) VALUES ("
						. " ". quote_smart(strtoupper($userid)) .",". quote_smart(md5("password")) .",". quote_smart($lvlID) .","
				...
				$sqlIns	= "INSERT INTO sys_User_Client ("
						. " Company_No,Company_Name,Reg_No,"
				...
				$sqlIns	.= " Phone_No,Fax_No,Email,"
						...
						. " Usr_ID"
						. " ) VALUES ("
						. " ". quote_smart($companyNo) .",". quote_smart($companyName) .",". quote_smart($regNo) .","
			...
			echo '
				<script language="Javascript">
				alert("'.$msg.'");
				location.href="userList.php?levelID='.$levelID.'";
				</script>
				';
			exit();
			/*********/
...
?>
	...
	<?php
		$lvlName = _getLabel($levelID,$arrLevel);
	?>
	<?php func_window_open2(_LBL_USER .' :: '. $addEdit .' ['. $lvlName .']'); ?>
	...
	<table border="0" class="contents" cellspacing="1" cellpadding="3" width="100%" align="center">
		...
		<tr class="contents">
			<td width="20%" class="label"><?= _LBL_LEVEL_TYPE . $requiredField ?></td>
			<td colspan="3"><?php
				$param1 = "lvlID";
				$param2 = "";
				$param3 = _get_arraySelect("sys_Level","Level_ID","Level_Name",array("AND Level_ID"=>"IN (6,7,8)"));
				$param4 = isset($_POST[$param1])?$_POST[$param1]:$lvlID;
		...
		<tr class="contents">
			...
			<td colspan="3"><label><?= $regId ?></label></td>
		</tr>
		<?php } ?>
		<tr class="contents">
		...
		<tr class="contents" height="30">
			<td colspan="4" class="label title"><?= _LBL_CONTACT_PERSON ?></td>
		</tr>
		<tr class="contents">
...
<!--
		<tr class="contents" height="30">
			<td colspan="4" class="label"><?= _LBL_VERIFICATION_CODE ?></td>
		</tr>
		<tr class="contents">
	...
	<table border="0" class="contents" cellspacing="1" cellpadding="3" width="100%" align="center">
		<tr class="contents">
			<td align="center"><?php
				...
				$param1 = 'cancel';
				$param2 = _LBL_CANCEL;
				$param3 = array('type'=>'button','onClick'=>'redirectForm(\'userList.php?levelID='.$levelID.'\');');
				echo form_button($param1,$param2,$param3);
				//========================================
			?></td>
		</tr>
