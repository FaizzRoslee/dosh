<?php
	//****************************************************************/
	// filename: hazPictogramList.php
	// description: list of the hazard pictogram
	//***************************************************************/
	...
	if(isset($_POST['checkbox']) && (isset($_POST['active']) || isset($_POST['inactive']))){
		...
		foreach($_POST['checkbox'] as $value){
			$sqlDel = "UPDATE tbl_Hazard_Pictogram SET"
					. " Active = ".quote_smart($active).","
					. " UpdateBy = ".quote_smart($updBy).","
					. " UpdateDate = NOW()"
					. " WHERE Pictogram_ID = ".quote_smart($value)." LIMIT 1"; //set active==0 instead delete from table;
			...
			//==========================================================
			func_add_audittrail($updBy,$msg.' ['.$value.']','Admin-Hazard Pictogram','tbl_Hazard_Pictogram,'.$value);
		}
...
?>
	...
	$(document).ready(function() {
		...
		var oTable = $('#example').dataTable( {
			...
			"sPaginationType": "full_numbers",
 			"bProcessing": true,
			"bServerSide": true,
			"sAjaxSource": "hazPictogramList_get.php",
			"aoColumns": [
				{ "sName": " ", "bSortable": false},
				{ "sName": "ht.Type_Name" },
				{ "sName": "hp.Pictogram_Desc" },
				{ "sName": "hp.Pictogram_Url" , "bSortable": false, "sClass": "center" },
				{ "sName": "hp.Active" },
				{ "sName": " ", "bSortable": false }
 			],
			"aaSorting": [[ 1, 'asc' ]],
	...
	<?php func_window_open2(_LBL_HAZARD_PICTOGRAM); ?>
				...
				<table style="width:100%">
					<tr>
						...
						<td width="40%" align="right"><?php
							...
							$param1 = 'add';
							$param2 = _LBL_ADD;
							$param3 = array('type'=>'button','onClick'=>'redirectForm(\'hazPictogramAddEdit.php\')');
				...
				<table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
					<thead>
						<tr>
							...
							<th width="19%"><?= _LBL_TYPE_NAME ?></th>
							<th width="30%"><?= _LBL_PICTOGRAM_DESC ?></th>
							<th width="20%"><?= _LBL_PICTOGRAM_FILE ?></th>
					...
					<tfoot>
						<tr>
							...
							<th><input type="text" name="search_desc" value="<?= _LBL_SEARCH .' '. _LBL_PICTOGRAM_DESC ?>" class="search_init" /></th>
							<th><input type="hidden" name="search_desc" value="<?= _LBL_SEARCH .' '. _LBL_PICTOGRAM_FILE ?>" class="search_init" /></th>
