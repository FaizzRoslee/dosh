<?php
	//****************************************************************/
	// filename: precautionStatementAddEdit.php
	// description: add & edit the precaution statement
	//****************************************************************/
	...
	//==========================================================
	if(isset($_POST['save'])){
		$statementCode = isset($_POST['statementCode'])?'P'.$_POST['statementCode']:'';
		...
		//==========================================================
		$param1 = 'tbl_Precaution_Statement';
		...
		if($rowExist!=0){
			...
			if($statementID!=0){
				...
				$sqlIns	= "INSERT INTO tbl_Precaution_Statement ("
						. " Statement_Code, Statement_Desc, Precaution_ID,"
						. " UpdateBy, UpdateDate,"
						. " RecordBy, RecordDate,"
						. " Active" 
						. " ) VALUES ("
			...
			//==========================================================
			func_add_audittrail($updBy,$msg.' ['.$statementID.']','Admin-Precaution Statement','tbl_Precaution_Statement,'.$statementID);
			echo '
				<script language="Javascript">
				alert("'.$msg.'");
				location.href="precautionStatementList.php";
				</script>
				';
			exit();
		}
	...
	if($statementID!=0){
		$dataColumns = '*';
		$dataTable = 'tbl_Precaution_Statement';
...
?>
	...
	<?php func_window_open2(_LBL_PRECAUTIONARY_STATEMENT .' :: '. $addEdit); ?>
	...
	<table border="0" class="contents" cellspacing="1" cellpadding="3" width="100%">
		<tr class="contents">
			<td width="20%" class="label"><?= _LBL_PRECAUTION_CODE ?></td>
			<td width="80%"><label>P</label> <?php
		...
		<tr class="contents">
			<td class="label"><?= _LBL_PRECAUTION_DESC ?></td>
			<td><?php
		...
		<tr class="contents">
			<td class="label"><?= _LBL_PRECAUTION_TYPE ?></td>
			<td><?php
				$param1 = 'typeID';
				$param2 = '';
				$param3 = _get_arraySelect('tbl_Precaution_Type','Precaution_ID','Precaution_Name');//($tblName='',$colID='',$colDesc='',$colWhere=array())
	...
	<table border="0" class="contents" cellspacing="1" cellpadding="3" width="100%">
		<tr class="contents">
			<td align="center"><?php
				...
				$param1 = 'cancel';
				$param2 = _LBL_CANCEL;
				$param3 = array('type'=>'button','onClick'=>'redirectForm(\'precautionStatementList.php\');');
				echo form_button($param1,$param2,$param3);
			?></td>
		</tr>
	</table>
