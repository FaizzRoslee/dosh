<?php
	...
	**********************************************************************************/	
	...
	//login
	define("_LBL_SEARCH_REG_CHEM","Searching for Registered Chemical");
	...
	define("_LBL_FILL_UP","Fill up no of substance/mixture to be submit");
	define("_LBL_CAN_BE_2","Can be Chemical Name/CAS No");
	...
	define("_LBL_DOSH_INFO", _LBL_DOSH ."<br />(". _LBL_MOHR .")<br />Level 2, 3, 4, Block D3, Complex D,<br />Federal Government Administrative Centre<br />62530 W.P. Putrajaya<br /><br />Phone no: 03-8871 1229<br />Fax no: 03-8889 2339<br />E-mail: ". $sys_config['email_admin']);
	...
	define("_LBL_DISCLAIMER_DETAIL","By submitting the above information, I have verified that all the content are correct. I understand that the document will be printed EXACTLY as its appear here, that I cannot make any changes once submitted and that I assume all responsibility in complying the CLASS Regulations");
	//============================================================================
	//for certificate
	...
	define("_LBL_CERT_ORG_INFO","Director,<br />Chemical Management Division,<br />Department of Occupational Safety and Health<br />(Ministry of Human Resource)<br />Level 2, 3, 4, Block D3, Complex D,<br />Federal Government Administrative Centre<br />62530 W.P. Putrajaya<br />Phone no: 03-8871 1229<br />Fax no: 03-8889 2339<br /><br />E-mail: ". $sys_config['email_admin']);
	...
	define("_LBL_CERT_SUBMISSION_TITLE",_LBL_SUBMISSION ." ". _LBL_APPROVED);
	...
	define("_LBL_CERT_SUBMISSION_SUBJ2","chemical inventory as above mentioned was ACKNOWLEDGED by the ". _LBL_DOSH .".<br />Please refer next page for details.<br /><br />For reference, please contact:<br /><br />");
	//============================================================================
	...
	define("_LBL_PLEASE_INSERT_CHEMICAL_MANUALLY","Please insert the chemical name manually");
?>