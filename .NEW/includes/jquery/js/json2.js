...
<script src="https://assets0.github.com/javascripts/bundle_github.js?d5fd66b54f6223e6f6008628f23f8e21d86d7012" type="text/javascript"></script>
  ...
  <link href="https://github.com/douglascrockford/JSON-js/commits/master.atom" rel="alternate" title="Recent Commits to JSON-js:master" type="application/atom+xml" />
    ...
    <script type="text/javascript">
      ...
      GitHub.commitSHA = "ad6079cbd8dc362a3cc42e1f97c01aa5ccd48bfe";
  ...
  <body class="logged_out page-blob">
    ...
    <ul class="actions">
        ...
        <li>
          <a href="/douglascrockford/JSON-js/toggle_watch" class="minibutton btn-watch " id="watch_button" onclick="var f = document.createElement('form'); f.style.display = 'none'; this.parentNode.appendChild(f); f.method = 'POST'; f.action = this.href;var s = document.createElement('input'); s.setAttribute('type', 'hidden'); s.setAttribute('name', 'authenticity_token'); s.setAttribute('value', 'fd8d19463e3154b89420a83a2c2afb5dc65a8a2c'); f.appendChild(s);f.submit();return false;" style="display:none"><span><span class="icon"></span>Watch</span></a>
          <a href="/douglascrockford/JSON-js/toggle_watch" class="minibutton btn-watch " id="unwatch_button" onclick="var f = document.createElement('form'); f.style.display = 'none'; this.parentNode.appendChild(f); f.method = 'POST'; f.action = this.href;var s = document.createElement('input'); s.setAttribute('type', 'hidden'); s.setAttribute('name', 'authenticity_token'); s.setAttribute('value', 'fd8d19463e3154b89420a83a2c2afb5dc65a8a2c'); f.appendChild(s);f.submit();return false;" style="display:none"><span><span class="icon"></span>Unwatch</span></a>
            ...
            <li class="for-notforked" style="display:none"><a href="/douglascrockford/JSON-js/fork" class="minibutton btn-fork " id="fork_button" onclick="var f = document.createElement('form'); f.style.display = 'none'; this.parentNode.appendChild(f); f.method = 'POST'; f.action = this.href;var s = document.createElement('input'); s.setAttribute('type', 'hidden'); s.setAttribute('name', 'authenticity_token'); s.setAttribute('value', 'fd8d19463e3154b89420a83a2c2afb5dc65a8a2c'); f.appendChild(s);f.submit();return false;"><span><span class="icon"></span>Fork</span></a></li>
      ...
      <li class="repostats">
        <ul class="repo-stats">
          <li class="watchers"><a href="/douglascrockford/JSON-js/watchers" title="Watchers" class="tooltipped downwards">244</a></li>
          <li class="forks"><a href="/douglascrockford/JSON-js/network" title="Forks" class="tooltipped downwards">9</a></li>
        </ul>
      </li>
    </ul>
  ...
  <ul>
    ...
    <div id="repo_details" class="metabox clearfix">
      ...
      <div id="repository_description_edit" style="display:none;" class="inline-edit">
        <form action="/douglascrockford/JSON-js/admin/update" method="post"><div style="margin:0;padding:0"><input name="authenticity_token" type="hidden" value="fd8d19463e3154b89420a83a2c2afb5dc65a8a2c" /></div>
...
<div class="flash-messages"></div>
  ...
  <div class="envelope commit">
    <div class="human">
        ...
        <div class="message"><pre><a href="/douglascrockford/JSON-js/commit/ad6079cbd8dc362a3cc42e1f97c01aa5ccd48bfe">Style conformance.</a> </pre></div>
      

      <div class="actor">
        <div class="gravatar">
          
          <img src="https://secure.gravatar.com/avatar/b871de839c31ddb1d9db8e33e0cb88a6?s=140&d=https://github.com%2Fimages%2Fgravatars%2Fgravatar-140.png" alt="" width="30" height="30"  />
        </div>
        <div class="name"><a href="/douglascrockford">douglascrockford</a> <span>(author)</span></div>
        <div class="date">
          <abbr class="relatize" title="2011-02-23 13:54:25">Wed Feb 23 13:54:25 -0800 2011</abbr>
        </div>
      </div>
    ...
    <div class="machine">
      <span>c</span>ommit&nbsp;&nbsp;<a href="/douglascrockford/JSON-js/commit/ad6079cbd8dc362a3cc42e1f97c01aa5ccd48bfe" hotkey="c">ad6079cbd8dc362a3cc4</a><br />
      <span>t</span>ree&nbsp;&nbsp;&nbsp;&nbsp;<a href="/douglascrockford/JSON-js/tree/ad6079cbd8dc362a3cc42e1f97c01aa5ccd48bfe" hotkey="t">728a1a001c6042aefa84</a><br />
      
        <span>p</span>arent&nbsp;
        
        <a href="/douglascrockford/JSON-js/tree/633fe5ae4bd69985254a68ae111505ec3d3e74ab" hotkey="p">633fe5ae4bd69985254a</a>
  ...
  <div id="slider">
    ...
    <div class="breadcrumb" data-path="json2.js/">
      <b><a href="/douglascrockford/JSON-js/tree/ad6079cbd8dc362a3cc42e1f97c01aa5ccd48bfe">JSON-js</a></b> / json2.js       <span style="display:none" id="clippy_2751">json2.js</span>
      ...
      <param name="quality" value="high" />
      <param name="scale" value="noscale" />
      <param NAME="FlashVars" value="id=clippy_2751&amp;copied=copied!&amp;copyto=copy to clipboard">
      <param name="bgcolor" value="#FFFFFF">
      <param name="wmode" value="opaque">
      <embed src="https://assets3.github.com/flash/clippy.swf?v5"
             width="110"
             ...
             type="application/x-shockwave-flash"
             pluginspage="http://www.macromedia.com/go/getflashplayer"
             FlashVars="id=clippy_2751&amp;copied=copied!&amp;copyto=copy to clipboard"
             bgcolor="#FFFFFF"
             wmode="opaque"
      />
      </object>
      ...
      <div class="frame frame-center" data-path="json2.js/">
        ...
        <div id="files">
          <div class="file">
            <div class="meta">
              <div class="info">
                <span class="icon"><img alt="Txt" height="16" src="https://assets0.github.com/images/icons/txt.png?f707e31c9a3cedd38dfce5a8e0475579e199a9bf" width="16" /></span>
  ...
  <img src="/images/modules/ajax/big_spinner_336699.gif">
    ...
    <div id="footer" class="clearfix">
      <div class="site">
        ...
        <ul class="sosueme">
          <li class="main">&copy; 2011 <span id="_rrt" title="0.04488s from fe4.rs.github.com">GitHub</span> Inc. All rights reserved.</li>
    ...
    <script>window._auth_token = "fd8d19463e3154b89420a83a2c2afb5dc65a8a2c"</script>
