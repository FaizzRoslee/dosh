...
?>
	...
	<div id="users-contain" class="ui-widget">
		...
		<div id="myTab">
			<ul>
				<li><a href="#tabs-1"><?= LBL_DETAILS ?></a></li>
				<li><a href="#tabs-2"><?= LBL_APPROVAL ?></a></li>
			</ul>
			
			<div id="tabs-1"><?php include_once('appl-view-details.php'); ?></div>
			<div id="tabs-2"><?php include_once('appl-view-approval.php'); ?></div>
		</div>
