...
?>
	...
	<table border="0" class="contents" cellspacing="1" cellpadding="3" width="100%">
		<tr class="contents">
			...
			?>
			<td width="12%" class="label" style="<?= $text_align_center ?>"><?= $trade_chemical ?></td>
			<td width="8%" class="label" style="<?= $text_align_center ?>"><?= _LBL_CAS_NO ?></td>
			<td width="15%" class="label" style="<?= $text_align_center ?>"><nobr><?= _LBL_HAZARD_CLASSIFICATION ?></nobr></td>
			<td width="7%" class="label" style="<?= $text_align_center ?>"><?= _LBL_APPROVED_DATE ?></td>
			<td width="7%" class="label" style="<?= $text_align_center ?>"><?= _LBL_EXPIRED_DATE ?></td>
			<?php 
					$minus_sup = 2;
 ...
 */			foreach($arrayData1 as $key => $detail1){
		...
		?>
		<tr class="contents">
			<td class="label" colspan="<?= (6-$minus) ?>" <?= $td_mid_right; ?>>&nbsp;</td>
			<?php
						if($uLevelID!=7){
			?>
