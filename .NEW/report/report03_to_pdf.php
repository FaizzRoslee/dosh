	...
	$tbl .= '
		...
		';
								...
								if($uLevelID<5 && $isCWC==1)
									$cwc = ' <b>['. _LBL_CWC .']</b>';
	$tbl .= '
			<td width="'. ( 13 + $width1 ) .'%" style="'. $text_valign_mid .'">'. (isset($arrayChem[$i]['Chemical_ID'])?nl2br(_get_StrFromCondition('tbl_Chemical','Chemical_Name','Chemical_ID',$arrayChem[$i]['Chemical_ID'])) . $cwc:'') .'</td>
