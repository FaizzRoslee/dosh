...
?>
	...
	$(document).ready(function() {
		...
		var oTable = $('#example').dataTable( {
			...
			"sPaginationType": "full_numbers",
 			"bProcessing": true,
			"bServerSide": true,
			"sAjaxSource": "chemicalList_get.php?userLevelID=<?= $userLevelID ?>&status=<?= $status ?>",
			"aoColumns": [
				...
				{ "sName": 'IF(isCWC=1, "<?= _LBL_YES ?>","<?= _LBL_NO ?>")', "sClass":"center" },
				{ "sName": " ", "bSortable": false }
 			],
			"aaSorting": [[ 2, 'asc' ]],
			"bSortClasses": true
	...
	<?php func_window_open2(_LBL_CHEMICAL); ?>
				...
				<table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
					...
					<tfoot>
						<tr>
							...
							<th><input type="hidden" name="search_iupac" value="<?= _LBL_SEARCH .' '. _LBL_CLASSIFIED ?>" class="search_init" /></th>
							<th><input type="text" name="search_cwc" value="<?= _LBL_SEARCH .' '. _LBL_CWC ?>" class="search_init" /></th>
