		...
		<div id="tabs-1">
			...
			<div id="preview-sub-button">
				...
				<table cellpadding="3" class="ui-widget"><tr>
					<td style="text-align: center;"><button id="sub-send"><?= _LBL_SAVE ?></button>&nbsp;<button id="sub-submit"><?= _LBL_SAVE ." & ". _LBL_SUBMIT . $spLoad ?></button>&nbsp;<button id="sub-cancel"><?= _LBL_CANCEL ?></button></td>
				</tr></table>
			</div>
