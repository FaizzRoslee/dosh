<?php
	...
	/*********/
	if($userLevelID>2 && $userLevelID!=4) exit();
	/*********/
	func_header("",
				"", // css		
	...
	/*********/
	if($new==6) $formBack = 'approvalNewList.php';
...
?>
	...
	<div id="tabs">
		...
		<?= form_input("fn","acknowledge",array("type"=>"hidden")); ?>
		...
		<table border="0" class="contents" cellspacing="1" cellpadding="3" width="100%">
			<tr class="contents">
				...
				<td width="75%"><?php
					$param1 = "approved";
					$param2 = array(
									array("value"=>"31","label"=>_LBL_ACKNOWLEGE),
									array("value"=>"2","label"=>_LBL_REJECTED_SEND_BACK)
							);
					$param3 = isset($_POST[$param1])?$_POST[$param1]:"31";
					$param4 = "&nbsp;&nbsp;";
