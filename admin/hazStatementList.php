<?php
	//****************************************************************/
	// filename: hazStatementList.php
	// description: list of the hazard statement
	//***************************************************************/
...
?>
	...
	$(document).ready(function() {
		...
		var oTable = $('#example').dataTable( {
			...
			"sPaginationType": "full_numbers",
 			"bProcessing": true,
			"bServerSide": true,
			"sAjaxSource": "hazStatementList_get.php",
			"aoColumns": [
				{ "sName": " ", "bSortable": false},
				{ "sName": "ht.Type_Name" },
				{ "sName": "hs.Statement_Code" },
				{ "sName": "hs.Statement_Desc" },
				{ "sName": "hs.Active" },
				{ "sName": " ", "bSortable": false }
 			],
			"aaSorting": [[ 2, 'asc' ]],
	...
	<?php func_window_open2(_LBL_HAZARD_STATEMENT); ?>
				...
				<table style="width:100%">
					<tr>
						...
						<td width="40%" align="right"><?php
							...
							$param1 = 'add';
							$param2 = _LBL_ADD;
							$param3 = array('type'=>'button','onClick'=>'redirectForm(\'hazStatementAddEdit.php\')');
				...
				<table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
					<thead>
						<tr>
							...
							<th width="10%"><?= _LBL_STATEMENT_CODE ?></th>
							<th width="42%"><?= _LBL_STATEMENT_DESC ?></th>
					...
					<tfoot>
						<tr>
							...
							<th><input type="text" name="search_code" value="<?= _LBL_SEARCH .' '. _LBL_STATEMENT_CODE ?>" class="search_init" /></th>
							<th><input type="text" name="search_name" value="<?= _LBL_SEARCH .' '. _LBL_STATEMENT_DESC ?>" class="search_init" /></th>
