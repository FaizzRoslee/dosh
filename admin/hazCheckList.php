				...
				<table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
					<thead>
						<tr>
							...
							<th width="14%"><?= _LBL_CHEMICAL_NAME ?></th>
					...
					<tfoot>
						<tr>
							...
							<th><input type="text" name="search_cod" value="<?= _LBL_SEARCH .' '. _LBL_CHEMICAL_NAME ?>" class="search_init" /></th>
