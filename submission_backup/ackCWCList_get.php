<?php
	...
	* Joining
	*/
	$sJoin = " LEFT JOIN tbl_Chemical c ON sc.Chemical_ID = c.Chemical_ID 
	...
	$sWhereCountAll = " WHERE 1 AND sd.Submission_ID IN (".$dSubSelect.")  AND isCWC = 1 ";
		...
		for ( $i=0 ; $i<$max_column ; $i++ ) {
			...
			if($colname==' '){
				...
				elseif($i == ($max_column-1) ){
					...
					$imgParam2 = _LBL_VIEW;
					$imgParam3 = 'redirectForm(\'ackCWCView.php?chemicalID='.$uniqueID.'\')';
