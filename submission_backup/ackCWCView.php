	...
	<div id="tabs">
		...
		<div id="tabs-1">
			<?php
				...
				$dataColumns1 = "Lbl_Statement_ID,Lbl_Signal_ID,Lbl_Pictogram_ID,Category_ID";
			...
			<table class="contents" cellspacing="1" cellpadding="3" width="100%">
				...
				<?php
					...
					foreach($arrayData2 as $detail2){ 
						...
						$dateexp	= _getExpiredDate($detail2["Submission_ID"]);
				?>
				<tr class="contents">
					<td align="center"><label><?= $i ?></label></td>
					<td><label><?= $compName; ?></label></td>
					<td align="center"><label><?= $lvlName; ?></label></td>
					<td align="center"><label><?= $detail2["Submission_Submit_ID"] ?></label></td>
	...
	<table border="0" class="contents" cellspacing="1" cellpadding="3" width="100%">
		<tr class="contents">
			<td align="center"><?php
				$param1 = "back";
				$param2 = _LBL_BACK;
				$param3 = array("type"=>"button","onClick"=>"redirectForm('ackCWCList.php');");
