...
?>
	...
	$(document).ready(function() {
		...
		var oTable = $("#example").dataTable( {
			...
			"bJQueryUI": true,
 			"bProcessing": true,
			"bServerSide": true,
			"sAjaxSource": "approvedNewList_state_get.php?levelID=<?= $levelID ?>&Usr_ID=<?= $Usr_ID ?>&langdesc=<?= $langdesc ?>",
			"aoColumns": [
	...
	<?php func_window_open2(_LBL_SUBMISSION ." :: ". _LBL_ACKNOWLEGED . (($levelID<=2)?" [". _LBL_STATE ."]":"")); ?>
