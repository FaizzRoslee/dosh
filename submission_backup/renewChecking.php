<?php
	//****************************************************************/
	// filename: renewChecking.php
	// description: checking for renew submission
	//****************************************************************/
	...
	//===================
	if($new==12) $formBack = 'checkingRenewList.php';
	...
	if(isset($_POST['save'])){
		...
		//==========================================================
		if($resUpd){
			if($statusID=='22') $msg = 'Submission was sent for approval.';
			elseif($statusID=='4') $msg = 'Submission was sent back to the supplier.';
			else $msg = 'NA';
			//==========================================================
		...
		<table border="0" class="contents" cellspacing="1" cellpadding="3" width="100%">
			<tr class="contents">
				...
				<td width="75%"><?php
					...
					$param3 = isset($_POST[$param1])?$_POST[$param1]:'22';
					$param4 = '&nbsp;&nbsp;';
