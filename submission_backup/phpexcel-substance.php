...
// Excel5
 ...
 // $objPHPExcel->setInputEncoding('ISO-8859-1');              // linuxhouse_debug_20211104		
	...
	function getChemicalCategory($name='',$casno=''){
        ...
        // linuxhouse_20220803
        // start penambahbaikan - 1_penggunaaan simbol di dalam submission - v004
        
        // Problem:
        // could not load files with greek characters
        
        // Solution:
        // in order to store and retrieve greek characters in mysql, the charset 
        // in one column in a table must be utf8( or utf8mb4) or the entire collation 
        // of the table must be changed  to a collation that support greek characters. 
        
        // sql query to check Character set of the columns of MySQL table?
        // Select Column_name 'Column', Character_set_name 'Charset' FROM
        // information_schema.columns where table_schema = 'db_name' and
        // table_name ='table_name';
        
        // sql query to alter/change the Character set of a column of MySQL table?
        // ALTER TABLE <table_name> MODIFY <column_name> VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
        
        // sql query used to alter/change the Character set of a column of MySQL table?
        // ALTER TABLE tbl_chemical MODIFY Chemical_Name VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci
        
        // sql query used to change character set for column Detail_ProductName in tbl_submission_detail
        // ALTER TABLE tbl_submission_detail MODIFY Detail_ProductName VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci
        
        // NOTE:
        // character set before bug fix for Chemical_Name & Detail_ProductName was latin1
        
		/* change character set to utf8 */
        // $db->sql_query("SET NAMES 'utf8'"); // this already set in database connection file
        // $db->sql_query("SET CHARACTER SET 'utf8'");
        $db->sql_query("SET NAMES 'utf8mb4'"); 
        $db->sql_query("SET CHARACTER SET 'utf8mb4'");
        
        // end penambahbaikan - 1_penggunaaan simbol di dalam submission - v004
