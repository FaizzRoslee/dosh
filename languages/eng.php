...
/**************************************************************************************************
	...
	**************************************************************************************************/	
	...
	define("_LBL_HAZARD_CHECKING","Hazard Checking");
	define("_LBL_HAZARD_TYPE","Hazard Type");
 ...
 define("_LBL_NOOF_CHEMICAL","No Of Chemicals");
    ...
    define("_LBL_ANNOUNCEMENT","Announcement");
	define("_LBL_ANNOUNCEMENT_LIST",_LBL_ANNOUNCEMENT ." ". _LBL_LIST);
	define("_LBL_MESSAGE_LIST",_LBL_MESSAGE ." ". _LBL_LIST);
	define("_LBL_TITLE","Title");
	define("_LBL_STARTING_DATE","Starting Date");
	define("_LBL_ENDING_DATE","Ending Date");
	define("_LBL_TITLE_EXIST","Title already exist. Please enter another title");
    ...
    define("_LBL_CONVERT_TO_EXCEL","Convert To Excel");
    define("_LBL_CONVERT_TO_WORD","Convert To Word");
    define("_LBL_TIME_LIMIT_EXCEEDED","Time limit exceeded. Click OK to re-download or click Cancel to exit");
    define("_LBL_MEMORY_LIMIT_EXCEEDED","Memory limit exceeded. Click OK to re-download or click Cancel to exit");
