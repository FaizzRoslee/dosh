<?php
	//****************************************************************/
	// filename: approvedNewList_state.php
	// description: list of the new submission that has been approved for state
	//***************************************************************/
...
/*
	$dColumn = 's.Submission_ID,s.Submission_Submit_ID,uc.Company_Name,u.Level_ID,s.Usr_ID,s.Status_ID';
	...
	$dWhere2 = array();
	if($levelID==5){ $dWhere2 = array("AND uc.State_Reg"=>"= ". quote_smart(_get_StrFromCondition('sys_User_Staff','State_ID','Usr_ID',$Usr_ID))); }
...
?>
	...
	$(document).ready(function() {
		...
		var oTable = $('#example').dataTable( {
			...
			"bJQueryUI": true,
 			"bProcessing": true,
			"bServerSide": true,
			"sAjaxSource": "approvedRenewList_state_get.php?levelID=<?= $levelID ?>&Usr_ID=<?= $Usr_ID ?>",
			"aoColumns": [
	...
	<?php func_window_open2(_LBL_RENEW_SUBMISSION .' :: '. _LBL_ACKNOWLEGED . (($levelID<=2)?' ['. _LBL_STATE .']':'')); ?>
				...
				<table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
					...
					<tfoot>
						<tr>
							...
							<th><?= form_input('search_ctype',_LBL_SEARCH .' '. _LBL_NO_OF_CHEMICAL,$arrOthText); ?></th>
