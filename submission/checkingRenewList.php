<?php
	//****************************************************************/
	// filename: checkingRenewList.php
	...
	if($levelID==5){ $dWhere = array("AND"=>"=0"); }
		...
		$dWhere1 = array("AND s.Status_ID"=>"IN (12)");
		$dWhere2 = array();
...
?>
	...
	<?php func_window_open2(_LBL_RENEW_SUBMISSION .' :: '. _LBL_CHECKING); ?>
				...
				<table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
					...
					<?php
						foreach($arrayData as $detail){
							...
							$imgParam2 = _LBL_VIEW;
							$imgParam3 = 'redirectForm(\'submissionView.php?submissionID='.$uniqueID.'&new=12\')';
							...
							if($statusID==12 && $levelID<=3){
								...
								$imgParam3 = 'redirectForm(\'renewChecking.php?submissionID='.$uniqueID.'&new=12\')';
								$activity .= '&nbsp;'._get_imagebutton($imgParam1,$imgParam2,$imgParam3);
							}
							//====================================================
							$lvlName = '-';
