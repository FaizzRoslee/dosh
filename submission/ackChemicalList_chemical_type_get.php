<?php
	...
	*/
	...
	$Usr_ID = $_GET["Usr_ID"];
	$chemical_type = $_GET["ChemicalType"];
	//==========================
	...
	// $dSubWhere = " AND (s.isDeleted = 0 AND s.ApprovedDate IS NOT NULL) AND s.Status_ID IN (31,32,33,51,41,42,43,52)";
	$dSubWhere = " AND (s.isDeleted = 0 AND s.ApprovedDate = sd.ApprovedDate) AND s.Type_ID='".$chemical_type."' AND s.Status_ID IN (31,32,33,51,41,42,43,52)";
	...
	$sGroup = " GROUP BY c.Chemical_Name ";
	// end penambahbaikan - 11_carian senarai pembekal bahan kimia - v001
