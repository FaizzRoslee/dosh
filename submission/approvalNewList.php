<?php
	...
	if($levelID==5){ $dWhere = array("AND"=>"=0"); }
		...
		$dWhere1 = array("AND s.Status_ID"=>"IN (21)");
		$dWhere2 = array();
...
?>
	...
	<?php func_window_open2(_LBL_SUBMISSION ." :: ". _LBL_APPROVAL); ?>
				...
				<table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
					...
					<?php
						foreach($arrayData as $detail){
							...
							$imgParam2 = _LBL_VIEW;
							$imgParam3 = "redirectForm('submissionView.php?submissionID=$uniqueID&new=6')";
							$activity .= _get_imagebutton($imgParam1,$imgParam2,$imgParam3);
							/*********/
							if($statusID==21 && ($levelID<=4&&$levelID!=3)){
								$imgParam1 = $sys_config["images_path"]."icons/verify.gif";
								$imgParam2 = _LBL_CHECKING;
								$imgParam3 = "redirectFormtab('submissionApprove.php?submissionID=$uniqueID&new=6','newtab-$uniqueID')";
								$activity .= "&nbsp;"._get_imagebutton($imgParam1,$imgParam2,$imgParam3);
							}
							/*********/
							$lvlName = "-";
